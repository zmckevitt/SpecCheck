...
BENCHMARK="619.lbm_s" # full benchmark name
BINARY="lbm_s_base" # binary file generated from SPEC
INPUT="2000 reference.dat 0 0 200_200_260_ldc.of" # input to binary
